    ...
    `}
        ...
        "
                    ...
                    <p className="text-xs text-gray-400 text-center mt-2 cursor-pointer ">
                      You will be redirected to your UPI app or need to Scan Qr
                    </p>
                  </div>
  ...
  "
    ...
    `}
        ...
        "
          ...
          ${
            isCardValid
              ? "bg-blue-500 text-black hover:bg-blue-400 cursor-pointer"
    ...
    `}
                >
                  <div className="px-4 py-4 space-y-3">
                    ...
                    {/* CONFIRM BUTTON */}
                    <button
                      onClick={() => toast.success("Cash on Delivery selected")}
                      className="
          w-full
          py-3
          rounded-xl
