  ...
  return (
    <>
      {/* ================= SEO ================= */}
        ...
        />
      <div className="bg-black text-gray-300 px-4 md:px-10 py-14">
        {/* HERO */}
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="mt-6 text-gray-400 max-w-3xl mx-auto text-lg">
            ...
            control. You manage your store, products, and delivery — we power
            the platform.
          </p>
        ...
        <div className="max-w-5xl mx-auto mt-24 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {["Register", "Complete KYC", "Add Products", "Start Selling"].map(
              (step, i) => (
                <div
                  key={i}
