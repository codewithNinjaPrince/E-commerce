...
const Collections = () => {
  ...
  const skeletonCount = typeof window !== "undefined" && window.innerWidth < 640 ? 10 : 15;
  ...
  return (
    <div className=" mt-5 pt-3 sm:pt-0 text-white min-h-screen ">
      <main role="main" aria-label="Brawvly product collections">

      <h1 className="sr-only">Shop All Collections on Brawvly</h1>
      ...
      <>
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs sm:text-sm text-gray-400 mb-4 max-w-3xl">
                    Explore all collections on <strong>Brawvly</strong>, an
                    Indian online marketplace offering fashion, electronics, and
                    lifestyle products from trusted local sellers across India.
                  </p>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
              ...
              {showEmpty && (
                <div className="col-span-full py-20 text-center text-gray-400">
                  No products found in this collection. Try adjusting filters or
                  explore other collections on Brawvly.
                </div>
              )}
            </div>
          </div>
