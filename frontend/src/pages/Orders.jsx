...
const shouldShowSkeleton = loading || !isOnline;
            ...
            {!loading && orders.length === 0 && (
              <div className="flex flex-col items-center py-24 text-center">
                ...
                <p className="text-gray-500 mb-6 max-w-sm">
                  You haven’t placed any orders yet. Discover amazing products
                  on Brawvly and start shopping now.
                </p>
              ...
              <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
                <div className="bg-[#1f1f1f] w-[90%] max-w-sm p-6 rounded-xl border border-red-500/50 shadow-xl">
                  ...
                  <p className="text-gray-300 mt-2 text-sm">
                    If you cancel now, you may not be able to avail this deal
                    again. Do you still want to cancel?
                  </p>
