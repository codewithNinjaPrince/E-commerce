          ...
          >
            ...
            <div className="lg:pl-10 xl:pl-16 pr-5">
              ...
              <p className="text-sm leading-relaxed text-gray-400">
                ...
                <span className="text-white font-medium">Brawvly</span>, we bring
                premium trends, everyday essentials, and stylish accessories from local sellers straight to you.
              </p>
            </div>
      ...
      >
        {item.label}
            ...
            <div className="lg:pl-10 xl:pl-16 pr-5">
              ...
              <ul className="space-y-3 text-sm text-gray-400">
  {[
    { label: "Shipping & Delivery", link: "/shipping-delivery" },
  ...
  <li className="transition-transform duration-300 hover:scale-[1.06] hover:text-white cursor-pointer">
    ...
    Noida, Uttar Pradesh, India - 201309
              ...
              <div className="flex gap-4 mt-5">
                {[
                  { src: "https://cdn-icons-png.flaticon.com/512/733/733585.png", link: "https://wa.me/918736852549" },
                  { src: "https://cdn-icons-png.flaticon.com/512/2111/2111463.png", link: "https://www.instagram.com/brawvly/" },
                  { src: "https://cdn-icons-png.flaticon.com/512/733/733547.png", link: "https://www.facebook.com/profile.php?id=61583969765648" },
                  ...
                  >
                    <img src={icon.src} className="w-5 invert" alt="social" />
                  </a>
                ))}
              </div>
            </div>
          ...
          <p className="text-center text-xs sm:text-sm text-gray-400 mt-4 cursor-pointer hover:scale-110 transition hover:text-white">
            © 2025 <span className="text-white">Brawvly</span> Marketplace — All Rights Reserved.
          </p>
