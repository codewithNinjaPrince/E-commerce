...
const Notification = () => {
  ...
  // unread count derived (no need for separate state)
    ...
    <div className="w-full max-w-[1600px] mx-auto p-4 sm:p-6 text-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-white via-gray-300 to-gray-500 bg-clip-text text-transparent cursor-pointer flex items-center gap-3">
            Notifications
          ...
          {notifications.length > 0 && (
            <button
              onClick={markAllRead}
              className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg text-sm shadow cursor-pointer"
            >
        ...
        {!loading && notifications.length === 0 && (
          <div className="bg-white/5 border border-white/10 rounded-xl p-10 text-center text-gray-400 cursor-pointer">
            ...
            <p className="text-gray-500 mt-1">
              All caught up! We'll notify you about new orders, messages, and updates.
            </p>
          </div>
        )}
          ...
          {notifications.map((n) => (
            ...
            >
              ...
              <button
                ...
                className="text-red-500 hover:text-red-700 p-2 rounded-lg hover:bg-red-500/10 transition cursor-pointer"
              >
                <FaTrash />
              </button>
            </div>
